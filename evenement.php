...
class evenement {
    ...
    function formatRow() {
        ...
        return "
            <tr>
                ...
                <td>$date_e</td>
                <td>
                    <a href='/web/BO/Views/details.php?id_e=$id' class='btn btn-info btn-sm'>View</a>
                    <a href='/web/BO/Views/FormUpdate.php?id_e=$id' class='btn btn-success btn-sm'>Edit</a>
                    <a href='/web/BO/Views/delete.php?id_e=$id' class='btn btn-danger btn-sm'>Delete</a>
    ...
    function formatRoww() {
        ...
        <td>$date_e</td>
        <td>
            <a href='/web/FO/read.php?id_e=$id' class='btn btn-info btn-sm'>View</a>
            <a href='/web/FO/reclamation/addr.php?id_e=$id' class='btn btn-dark float-end'>Create Reclamation</a>
